...
doc_segment = segment.Heuristic()
doc_parser = parser()
doc_tokenizer = tokenizer.SentencePiece()
doc_reporter = report.Reporter(output_dir="", visualizer=[], summarizer=[])
...
# from document.main import legacy_sentences_from_raw_text
#
# rebuild = False
#
# #
